...
2. Search product, project, customer, workflow, ops, initiative, and agenda handles.
3. Search 2-5 key attendees.
4. Query for prior discussion, open items, blockers, next steps, risks, and ownership context.

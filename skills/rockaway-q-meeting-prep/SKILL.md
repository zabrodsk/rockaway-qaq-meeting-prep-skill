...
description: Prepare a private dense Word meeting-prep brief for Rockaway Q / QAQ using the user's connected calendar/account context and the read-only Rockaway Q brain MCP. Use for Rockaway Q or QAQ meeting prep, Q team prep, product/ops/customer/project meeting prep, today's remaining Q meetings, next meeting prep, or what to discuss in an upcoming Rockaway Q call.
---
...
~/Rockaway Meeting Briefs/q/YYYY-MM-DD/
  rockaway-q-meeting-prep-YYYY-MM-DD.docx
```
